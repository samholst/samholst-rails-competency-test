...
@editor_user_2 = EditorUser.create!(
                                    first_name: "Editor_2",
                                    last_name: "User_2",
